...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ThalesLiu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '慎独', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://thalesliu-blog.vercel.app', // 网站地址
